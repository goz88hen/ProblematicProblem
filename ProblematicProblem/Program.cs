            ...
            var contResponse = Console.ReadLine().ToLower();
                ...
                if (seeList)
                {
                    ...
                    while (addToList)
                    {
                        ...
                        addToList = (Console.ReadLine().ToLower() == "sure") ? true : false;
                    ;
                    Console.WriteLine();
                ...
                while (cont)
                {
                    ...
                    Console.Write($"Ah got it! {userAge}, your random activity is: {randomActivity}! Is this ok or do you want to grab another activity? Keep/Redo: ");
                    Console.WriteLine();
